<template>
    ...
    <div class="dashboard-content container mt-3 ">
      <div class="d-flex justify-content-center">
        ...
        <div class="category-container mx-5">
          <CategoryComponent :transactions="transactions" :categories="categories" />
        </div>
      </div>
    </div>
  </div>
  ...
  onMounted(async() => {
    try {
      ...
      totalMonthly.income.amount = incomeSum;
      totalMonthly.expenese.amount = expenseSum;
      totalMonthly.balance.amount = incomeSum - expenseSum;
